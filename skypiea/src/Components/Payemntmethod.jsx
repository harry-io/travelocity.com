  ...
  return (
    <div className="paymentmethod">
      ...
      <form className="paymentmethod-form">
        ...
        <input type="text" placeholder="eg, Tony Chopper" />

        <label htmlFor="">
          <span>Debit/Credit card number</span>
          <span className="form-star">*</span>
        </label>
        <input type="text" placeholder="eg, 1234 5678 1234 5678" />
        ...
        <div className="formsk">
          <div>
            ...
            <input className="seckey sc" type="text" placeholder="eg, 123" />
          </div>
          ...
          <div>
            ...
            <input type="text" className="formbz sc" placeholder="eg, 800001" />
          </div>
        </div>
